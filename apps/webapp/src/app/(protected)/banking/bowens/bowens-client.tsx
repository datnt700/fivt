...
export default function BowensBankingClient() {
  ...
  const handleConnectionSuccess = (data: { webviewUrl: string; userId: string }) => {
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-lg text-gray-600">
            {t('subtitle_bowens', { fallback: 'Connect your bank account with Bowens' })}
          </p>
        </div>
          ...
          <div className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  {t('security.description_bowens', { fallback: 'Your banking data is secure with Bowens' })}
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  {t('features.description_bowens', { fallback: 'Access your financial data with Bowens' })}
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2 text-sm text-gray-600">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  {t('benefits.description_bowens', { fallback: 'Get insights into your finances with Bowens' })}
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2 text-sm text-gray-600">
