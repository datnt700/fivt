...
import { useCreateTransaction, useTransactions } from '@/app/(protected)/(dashboard)/transactions/_hooks/use-transaction';
...
// Mock the services
vi.mock('@/app/(protected)/(dashboard)/transactions/_services/transaction-service', () => ({
  transactionService: {
...
describe('useCreateTransaction', () => {
  ...
  it('should create transaction successfully', async () => {
    ...
    mockTransactionService.createTransaction.mockResolvedValueOnce(mockCreatedTransaction);
    ...
    expect(mockTransactionService.createTransaction).toHaveBeenCalledWith(mockTransactionData, expect.any(Object));
  ...
  it('should handle creation errors', async () => {
    ...
    mockTransactionService.createTransaction.mockRejectedValueOnce(new Error(errorMessage));
  ...
  it('should handle different transaction types', async () => {
    const testCases: Array<{ type: 'INCOME' | 'EXPENSE'; description: string }> = [
  ...
  it('should provide loading state correctly', async () => {
    ...
    mockTransactionService.createTransaction.mockReturnValueOnce(pendingPromise);
...
describe('useTransactions', () => {
  ...
  it('should fetch transactions successfully', async () => {
    ...
    mockTransactionService.getTransactions.mockResolvedValueOnce(mockTransactions);
  ...
  it('should handle fetch errors', async () => {
    ...
    mockTransactionService.getTransactions.mockRejectedValueOnce(new Error(errorMessage));
  ...
  it('should handle different locales correctly', async () => {
    ...
    for (const locale of locales) {
      ...
      expect(mockTransactionService.getTransactions).toHaveBeenCalledWith(locale);
  ...
  it('should handle network errors gracefully', async () => {
    mockTransactionService.getTransactions.mockRejectedValueOnce(new Error('Network error'));
...
describe('Hook Integration Tests', () => {
  ...
  it('should work together - create then fetch transactions', async () => {
    ...
    mockTransactionService.createTransaction.mockResolvedValueOnce(createdTransaction);
    ...
    const { result: queryResult } = renderHook(() => useTransactions(), { wrapper });
    ...
    const { result: mutationResult } = renderHook(() => useCreateTransaction(), { wrapper });
