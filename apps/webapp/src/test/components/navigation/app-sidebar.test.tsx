...
vi.mock('@/components/ui/sidebar', () => ({
  Sidebar: ({
    ...
    <div data-testid="sidebar" data-variant={variant} {...props}>
      {children}
    </div>
  ),
...
describe('AdminSidebar', () => {
  ...
  it('should handle very long user data', () => {
    const longUserProps = {
      ...
      email:
        'this.is.a.very.long.email.address.that.might.overflow@example.com',
      image:
        'https://example.com/very/long/path/to/avatar/image/that/might/cause/issues.jpg',
    };
  ...
  it('should maintain navigation item order', () => {
    ...
    // Third item should be Budget Tracking
    expect(navItems[2]).toHaveTextContent('Budget Tracking');
    expect(navItems[2]).toHaveTextContent('/budget');
