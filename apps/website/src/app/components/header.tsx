...
import { FranceFlag } from '../_component/Icons/Flag/france';
import { EnglandFlag } from '../_component/Icons/Flag/england';
import { VietnamFlag } from '../_component/Icons/Flag/vietnam';
...
export const Header = () => {
  ...
  return (
    <header
      className={`w-full sticky top-0 z-50 bg-white ${isLightHeader && 'shadow-[0px_4px_6px_0px_rgba(0,_0,_0,_0.1)]'}`}
    >
      <nav className="flex justify-between items-center w-full p-5 md:px-10 lg:px-30 xl:px-40 2xl:px-50">
